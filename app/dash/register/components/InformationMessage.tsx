...
export const InformationMessage = () => {
    ...
    return(
        ...
        <section className="bg-[#1B1B1B] text-white w-full h-full flex justify-center items-center">
            
            <div className="flex flex-col w-full w-max-[50vh] h-full space-y-5 p-8 ">
                ...
                <div className="space-y-4">
                        ...
                        <p className="text-sm break-all font-semibold ">When uploading your image or vector, please be aware that our moderators will review the content to ensure it complies with these requirements and our usage policies. If your content does not meet these standards, it may be removed from the platform.</p>
                </div>
            </div>
